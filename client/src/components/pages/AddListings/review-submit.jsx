...
const ReviewAndSubmit = ({
  ...
  const storeSelectedAmenities = (boolList) => {
    const amenities = [
      "Air Conditioner",
      "Parking",
      "Furnishing",
    ...
    boolList.forEach((bool, index) => {
      if (bool) {
        selectedAmenities.push(amenities[index]);
      }
    });
  ...
  const selectedAmenities = storeSelectedAmenities(amenities);
          ...
          <div className="listing_container">
            ...
            <div className="submit_grid">
              <div className="flex_right">
                <p>
                  Address: {address[0]}, {address[1]}, {address[3]},{" "}
                  {address[4]} {address[5]}
                </p>
                <button
                  className="btn--outline--small-review"
                  onClick={() => setCurrentPage(0)}
                >
                  Edit Address
                </button>
                <p>Amenities: {selectedAmenities.join(", ")}</p>
                <button
                  className="btn--outline--small-review"
